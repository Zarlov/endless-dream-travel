...
const entities = {
  ...
  EdtTripTraveler: {
    ...
    fields: { name: field('varchar', { maxLength: 180 }), externalId: externalIdField(60), trip: field('link', { required: true }), contact: field('link', { required: true }), travelerRole: field('enum', { options: ['Primary','Traveler','Guest','Group Lead'], default: 'Traveler' }) },
    ...
    detail: [['trip','contact'],['travelerRole',false],['externalId',false]], list: ['trip','contact','travelerRole'], filters: ['trip','contact','travelerRole'], bottom: []
  },
  EdtBookingTraveler: {
