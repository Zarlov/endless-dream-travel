...
const weeklySpecials = buildWeeklySpecials(brandLogos);
            ...
            <CardContent className="p-6 sm:p-8">
              <form className="grid gap-5" onSubmit={handleVacationRequest}>
                <input
                  type="hidden"
                  name="_subject"
                  value="New Vacation Quote Request"
                />
                <input
                  type="hidden"
                  name="source"
                  value="Endless Dream Travel Website"
                />
                ...
                {formStatus === "error" && (
                  <p className="rounded-2xl bg-red-100 p-4 text-center text-sm font-bold text-red-800">
                    Something went wrong. Please email amy@endlessdreamtravel.com
                    directly.
                  </p>
                )}

                <p className="text-center text-xs leading-5 text-black/50">
                  Prefer email? Send your vacation details to
                  amy@endlessdreamtravel.com and we will help you get started.
                </p>
              </form>
            </CardContent>
          </Card>
